...
export default function InterviewerHeader({ onToggleSidebar }) {
  const [searchQuery, setSearchQuery] = useState('');
  const [dateRange, setDateRange] = useState('18 Oct - 18 Nov 2024');
  ...
  return (
    <header className="h-auto md:h-20 flex flex-col md:flex-row items-center justify-between gap-4 px-1 mb-6 pt-2">
      {/* Mobile Logo Brand + Search Input */}
      <div className="flex items-center gap-4 w-full md:w-auto">
        <div className="md:hidden shrink-0">
          <CodeTierLogo className="h-8 w-auto" />
      ...
      {/* Right Tools: Date Range + Live Time Badge + Notifications */}
